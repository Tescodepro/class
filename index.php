                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="controller/authController.php" method="POST">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Matric Number" required name="matric_number" require>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-success btn-block" name="log_in">Sign Me In</button>
                                        </div>
                                    </form>
